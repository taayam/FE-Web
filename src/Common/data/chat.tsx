...
const Documents = [
    ...
    { id: 3, title: "bimoo-design.psd", size: "97.59 MB" },
    ...
    { id: 7, title: "bimoo-design.psd", size: "97.59 MB" },
    { id: 8, title: "bimoo.zip", size: "35.89 MB" },
    { id: 9, title: "bimoo-design.psd", size: "97.59 MB" },
];
