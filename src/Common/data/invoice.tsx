...
const RecentBiogasData = [
    { name: "Biogas Production", description: "Daily Production", amount: "50 m³", status: "Operational", type: "input" },
    { name: "Energy Generated", description: "Daily Energy Output", amount: "35 kWh", status: "Operational", type: "output" },
    { name: "Biogas System", description: "System Status", amount: "Operational", status: "Operational", type: "input" },
    { name: "Energy Efficiency", description: "System Efficiency", amount: "80%", status: "Operational", type: "input" },
];
export { InvoiceList,RecentBiogasData };
