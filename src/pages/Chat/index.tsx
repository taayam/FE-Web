...
const Chat = () => {
    ...
    document.title = `Chat | Bimoo - React `;
                                        ...
                                        <Tab.Pane eventKey='profile' className="tab-pane" id="profile">
                                            <SimpleBar className="max-h-[calc(100vh_-_250px)] xl:max-h-full card-body">
                                                ...
                                                <div className="mt-5">
                                                    ...
                                                    <h6 className="font-medium"><Mail className="inline-block size-4 mr-1 text-slate-500 dark:text-zink-200" /> <span className="align-middle">william@bimoo.com</span></h6>
                                                </div>
                                                <div className="mt-5">
                        ...
                        <Drawer.Body>
                            <div>
                                ...
                                <div className="mt-5">
                                    ...
                                    <h6 className="font-medium"><Mail className="inline-block size-4 ltr:mr-1 rtl:ml-1 text-slate-500 dark:text-zink-200" /> <span className="align-middle">william@bimoo.com</span></h6>
                                </div>
                                <div className="mt-5">
                                    <div className="flex items-center gap-2 mb-4">
                                        <p className="text-slate-500 dark:text-zink-200 grow">Settings</p>
